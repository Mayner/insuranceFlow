(function () {
	 ...
	 */
    function IosSelect01(level, data, options) {
    ...
    IosSelect01.prototype = {
        ...
        getTwoLevel: function (oneLevelId) {
            window.cityObject.refreshCitys(oneLevelId);//这里通过ajax同步去更新 内存堆 中的 this.data[1] 数组
            var twoLevelData = [];
        ...
        getThreeLevel: function (oneLevelId, twoLevelId) {
            window.countyObject.refreshCountys(oneLevelId, twoLevelId);//这里通过ajax同步去更新 内存堆 中的 this.data[2] 数组
            var threeLevelData = [];
        ...
        setThreeLevel: function (oneLevelId, twoLevelId, threeLevelId) {
            ...
            threeHtml += '<li></li>';
            threeHtml += '<li></li>';
            threeHtml +='<li data-id="0" data-value="" data-parentid="" class="at">请选择</li>';
    ...
    if (typeof module != 'undefined' && module.exports) {
        module.exports = IosSelect01;
    } else if (typeof define == 'function' && define.amd) {
        define(function () {
            return IosSelect01;
        });
    } else {
        window.IosSelect01 = IosSelect01;
    }
})();