(function () {
    ...
    IosSelect.prototype = {
        ...
        getTwoLevel: function (oneLevelId) {
            window.citysObject.refreshCitys(oneLevelId);//这里通过ajax同步去更新 内存堆 中的 this.data[1] 数组
            var twoLevelData = [];
        ...
        getThreeLevel: function (oneLevelId, twoLevelId) {
            window.countysObject.refreshCountys(oneLevelId, twoLevelId);//这里通过ajax同步去更新 内存堆 中的 this.data[2] 数组
            var threeLevelData = [];
