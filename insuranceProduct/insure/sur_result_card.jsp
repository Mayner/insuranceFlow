...
<body>
        ...
        <section class="pl pr pt bgColor">
            ...
            <div class="orderDetails w100">
                ...
                <c:if test="${insured.copiesNo!=null && insured.copiesNo!=''}">
	                <dl>
	                    <span class="orderLeft">邮编：</span><span class="orderRight">${insured.copiesNo }份</span>
	                </dl>
                </c:if>
    ...
    <section class="pt borBot1 bgColor">
	    <form id="payTypeForm" action="/pay/getPayPage" method="post">
	        ...
	        <div class="pl pr borTop1 borBot1 smallPay">
	            <dl class="clearfix infoDl borBot1 w100 creditCard">
	                <dt class="w40 l-float">信用卡支付</dt>
	                <dd class="w60 r-float choose">
	                    <i class="checkBox" id="creditCard"></i>
	                    <input type="radio" checked name="payType" class="payType" value="2" style="display: none;">
	                </dd>
	            </dl>
	            <dl class="clearfix infoDl w100 depositCard">
	                <dt class="w40 l-float">储蓄卡支付</dt>
	                <dd class="w60 r-float choose">
	                    <i class="unCheckBox" id="depositCard"></i>
	                    <input type="radio"  name="payType" class="payType" value="3" style="display: none;">
	                </dd>
	            </dl>
	        </div>
	    </form>
